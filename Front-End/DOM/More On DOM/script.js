...
function addData() {
  ...
  reels.forEach(function (elem, idx) {
    sum += `<div class="reel">
              <video class="main-video" ${elem.isMuted ? "muted" : ""} autoplay loop src="${elem.video}"></video>
              ...
              <div class="user">
                <img
                  ...
                  alt=""
                />
                <h4 class="user-name">${elem.username}</h4>
            ...
            <div class="right">
              ...
              <div class="save">
                <h4 class="save-icon icon"><i class="ri-more-2-fill"></i></h4>
              </div>
            </div>
          </div>`;
  });
